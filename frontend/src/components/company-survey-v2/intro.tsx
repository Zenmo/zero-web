...
export const Intro: FunctionComponent = () => {
    return (
        <>
            <h1>Data formulier energie en mobiliteit Hessenpoort</h1>
            <p>
                Met dit formulier halen we de energie- en mobiliteitsdynamieken op van Hessenpoort, zowel in de 
            ...
            <p>
                ...
                Parkmanagement Hessenpoort beheert de gegevens tijdens het project en Zenmo Simulations laadt ze
                in de digtial twin.
            </p>
            <p>
            ...
            <p>
                ...
                via info@ondernemersvereniginghessenpoort.nl. We kunnen jullie situatie dan realistischer meenemen 
                in de digital twin
            </p>
